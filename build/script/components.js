  ...
  if ("querySelector" in document && "addEventListener" in window) {
    ...
    var setupLocations = function () {
      ...
      forEach(links, function (i, el) {
        ...
        // Making sure we have an actual element we can work with. Prevent
        // breaking the page.
    ...
    forEach(links, function (i, el) {
      links[i].addEventListener("click", function (e) {
        ...
        // Check if we have an element to work with, otherwise we have a large
        // chance we are breaking the page.
        if (pane != null) {
          e.preventDefault();
          wasNavigationTapped = true;
          ...
          // If the URL isn't "#main", change it
          if (thisID !== "main") {
            pane.removeAttribute("id");
            location.hash = "#" + thisID;
            pane.setAttribute("id", thisID);

          // If the URL is "#main", remove hash from the URL
          } else {
            if (history.pushState) {
              history.pushState("", document.title, window.location.pathname);
            }
